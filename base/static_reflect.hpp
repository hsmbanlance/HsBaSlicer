...
struct FieldInfo
{
    ...
    static FieldT& Get(ClassT& obj) noexcept { return obj.*FieldPtr; }
    static const FieldT& Get(const ClassT& obj) noexcept { return obj.*FieldPtr; }
    constexpr std::string_view GetName() const noexcept { return FieldName.ToStringView(); }
};
...
struct MethodInfo
{
    ...
    constexpr std::string_view GetName() const noexcept { return MethodName.ToStringView(); }
};
...
public:
    using Type = T;
    static constexpr std::string_view ClassName() noexcept { return T::ClassName.ToStringView(); }
    static constexpr size_t FieldCount() noexcept { return std::tuple_size_v<typename T::FieldList>; }
    ...
    static constexpr size_t MethodCount() noexcept { return std::tuple_size_v<typename T::MethodList>; }
    template <size_t Index>
