...
{
public:
    WeldRobotPath(RLType robotType = RLType::Unknown, OutPoints3 startPoint = {},
                  std::string startProgramFunc = "", std::string endProgramFunc = "");
    ...
    std::string ToString(std::string_view script,
