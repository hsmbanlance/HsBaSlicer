...
PointsPath::PointsPath(GCodeUnits units, OutPoints3 p) : units_{units}, startPoint_{p}, points_{}
{
}
...
std::string PointsPath::ToString(std::string_view script, const std::function<void(lua_State*)>& lua_reg) const
{
    std::string result;
...
void PointsPath::Save(const std::filesystem::path& path, const std::filesystem::path& script_file,
