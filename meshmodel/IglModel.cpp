...
std::size_t std::hash<Eigen::MatrixXf>::operator()(const Eigen::MatrixXf& matrix) const noexcept
{
    std::size_t seed = 0;
...
std::size_t std::hash<Eigen::MatrixXi>::operator()(const Eigen::MatrixXi& matrix) const noexcept
{
    std::size_t seed = 0;
...
std::size_t std::hash<HsBa::Slicer::IglModel>::operator()(const HsBa::Slicer::IglModel& model) const noexcept
{
    std::size_t seed = 0;
