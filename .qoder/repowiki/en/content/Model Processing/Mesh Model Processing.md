...
5. [IglModel Implementation](#iglmodel-implementation)
6. [Model Format Support](#model-format-support)
7. [Primitive Creation](#primitive-creation)
8. [Transformation Operations](#transformation-operations)
9. [Boolean Operations](#boolean-operations)
10. [Slicing Pipeline Integration](#slicing-pipeline-integration)
...
- [FullTopoModel.hpp](file://meshmodel/FullTopoModel.hpp#L42-L114)
...
**Diagram sources**
- [CgalModel.hpp](file://meshmodel/CgalModel.hpp#L60-L64)
- [CgalModel.cpp](file://meshmodel/CgalModel.cpp#L195-L351)
- [IglModel.hpp](file://meshmodel/IglModel.hpp#L50-L54)
...
**Diagram sources**
- [IModel.hpp](file://base/IModel.hpp#L22-L28)
...
- [FullTopoModel.hpp](file://meshmodel/FullTopoModel.hpp#L93-L108)
...
- **CgalModel**: Recommended for CAD operations, boolean combinations, and precision engineering tasks where geometric accuracy is paramount
