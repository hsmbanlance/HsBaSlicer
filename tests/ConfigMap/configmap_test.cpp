...
BOOST_AUTO_TEST_CASE(test_eigenvector_toptree)
{
    ...
    boost::property_tree::ptree ptree;
    ptree.add<Eigen::Vector2f>("vector2f", Eigen::Vector2f{0.12f, -1e6f},
                               HsBa::Slicer::Utils::EigenVector2fTranslator{});
    auto v2f =
        ptree.get<Eigen::Vector2f>("vector2f", Eigen::Vector2f{}, HsBa::Slicer::Utils::EigenVector2fTranslator{});
    ...
    auto v2i =
        ptree.get<Eigen::Vector2i>("vector2i", Eigen::Vector2i{}, HsBa::Slicer::Utils::EigenVector2iTranslator{});
...
BOOST_AUTO_TEST_CASE(test_configmap_eigenvector_toptree)
{
    ...
    auto ptree = map.ToPtree();
    HsBa::Slicer::Config::ChangeTranslator<Eigen::Vector4i>(ptree, "v4i",
                                                            HsBa::Slicer::Utils::EigenVector4iTranslator{});
