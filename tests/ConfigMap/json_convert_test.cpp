...
struct ReflectPerson
{
    ...
    using FieldList = std::tuple<
        ...
        HsBa::Slicer::Utils::StaticReflect::FieldInfo<ReflectPerson, Sexual, "sexuality"_ts,
                                                      &ReflectPerson::sexuality>>;
...
struct ReflectCouple
{
    ...
    using FieldList = std::tuple<HsBa::Slicer::Utils::StaticReflect::FieldInfo<ReflectCouple, ReflectPerson,
                                                                               "person1"_ts, &ReflectCouple::person1>,
                                 HsBa::Slicer::Utils::StaticReflect::FieldInfo<ReflectCouple, ReflectPerson,
                                                                               "person2"_ts, &ReflectCouple::person2>>;
    using MethodList = std::tuple<>;
...
public:
    ...
    bool operator==(const WithJson& o) const { return o.x == x && o.y == y; }
...
BOOST_AUTO_TEST_CASE(test_json_throw)
{
    ...
    BOOST_TEST_MESSAGE(
        "Member must be aggregate or number or string or enum or which has to_string and from_string methods");
}
