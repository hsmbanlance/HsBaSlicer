...
BOOST_AUTO_TEST_CASE(test_from_variant)
{
    ...
    BOOST_REQUIRE_MESSAGE(boost::variant2::get<int>(boost_v2) == 1,
                          "Failed to convert from std::variant to boost::variant2");
}
...
BOOST_AUTO_TEST_CASE(test_from_boost_variant)
{
    ...
    auto boost_v2 = HsBa::Slicer::Utils::CopyToBoostVariant2(std_v);
    BOOST_REQUIRE_MESSAGE(boost::variant2::get<int>(boost_v2) == 1,
                          "Failed to convert from boost::variant to boost::variant2");
}
