...
BOOST_AUTO_TEST_CASE(test_std_any_one_arg)
{
    ...
    std::any any = 42;
    int v = HsBa::Slicer::Utils::Visit<int>([](int i) -> int { return i + 1; }, any);
    BOOST_REQUIRE_MESSAGE(v == 43, "Visit failed");
    any = std::string{"4"};
    v = HsBa::Slicer::Utils::Visit<int>([](int i) -> int { return i + 1; }, any);
...
BOOST_AUTO_TEST_CASE(test_std_any_two_arg)
{
    ...
    std::any any = 42;
    auto v = HsBa::Slicer::Utils::Visit<int, double>(
        [](auto&& i) -> int
        {
    ...
    any = 42.0;
    v = HsBa::Slicer::Utils::Visit<int, double>(
        [](auto&& i) -> int
        {
            if (typeid(i) == typeid(int))
                return 42;
