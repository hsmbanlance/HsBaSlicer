...
BOOST_AUTO_TEST_CASE(test_generator_invoke_throw)
{
    ...
    HsBa::Slicer::Utils::Generator<int>::SetOnCancel([]() { BOOST_TEST_MESSAGE("Generator canceled"); });
    std::list<int> l{0, 1, 2, 3, 4, 5};
...
BOOST_AUTO_TEST_CASE(test_tasks_int_noop)
{
    ...
    {
        HsBa::Slicer::Utils::Task<void, HsBa::Slicer::Utils::NoopExecutor> exampleTask =
            []() -> HsBa::Slicer::Utils::Task<void, HsBa::Slicer::Utils::NoopExecutor>
        {
            BOOST_TEST_MESSAGE("co_await void");
            co_return;
        }();
...
BOOST_AUTO_TEST_CASE(test_tasks_void_noop)
{
    ...
    {
        HsBa::Slicer::Utils::Task<int, HsBa::Slicer::Utils::NoopExecutor> exampleTask =
            []() -> HsBa::Slicer::Utils::Task<int, HsBa::Slicer::Utils::NoopExecutor>
        {
            BOOST_TEST_MESSAGE("co_await int");
            co_return 8;
        }();
